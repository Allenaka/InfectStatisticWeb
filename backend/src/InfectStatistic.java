...
public class InfectStatistic {
    ...
    public static class FileUtil {
        ...
        public String[] readLog(Commands cmds) throws Exception {
            ...
            if (file.exists()) {
                ...
                cmds.date = filter_lists[filter_lists.length - 1].substring(0, 10);
                return filter_lists;
    ...
    public static class unitTest {
        ...
        public void testMain01() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0", "-out", 
            "C:/Users/13067/Desktop/ListOut1.txt", "-date", "2020-01-23"};
            InfectStatistic.main(commands);
        }

        @Test
        public void testMain02() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0/log", "-out", 
            "C:/Users/13067/Desktop/ListOut2.txt"};
            InfectStatistic.main(commands);
        }
        ...
        public void testMain03() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0/log", "-out", 
            "C:/Users/13067/Desktop/ListOut3.txt", "-type", "ip", "cure"};
            InfectStatistic.main(commands);
        }
        ...
        public void testMain04() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0/log", "-out", 
            "C:/Users/13067/Desktop/ListOut4.txt", "-province", "全国", "福建" };
            InfectStatistic.main(commands);
        } 
        ...
        public void testMain05() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0/log", "-out", 
            "C:/Users/13067/Desktop/ListOut5.txt", "-type", "ip", "cure", "-province", 
            "福建", "湖北"};
            InfectStatistic.main(commands);
        }
        ...
        public void testMain06() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0/log", "-out", 
            "C:/Users/13067/Desktop/ListOut6.txt", "-province", "全国", "福建", "上海"};
            InfectStatistic.main(commands);
        }        
        ...
        public void testMain07() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0/log", "-out", 
            "C:/Users/13067/Desktop/ListOut7.txt", "-province", "全国", "湖北", "安徽", 
            "-type", "sp", "cure", "dead", "-date", "2020-01-22"};
            InfectStatistic.main(commands);
        } 
        ...
        public void testMain08() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0/log", "-out", 
            "C:/Users/13067/Desktop/ListOut8.txt", "-province", "全国", "福建", "上海", 
            "-type", "dead", "ip", "cure", "sp"};
            InfectStatistic.main(commands);
        } 
        ...
        public void testMain09() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0/log", "-out", 
            "C:/Users/13067/Desktop/ListOut9.txt", "-province", "全国", "加利福尼亚", "福建"};
            InfectStatistic.main(commands);
        } 
        ...
        public void testMain10() throws Exception {
            String[] commands = {"list", "-log", "C:/Users/13067/Desktop/test2.0/log", "-out", 
            "C:/Users/13067/Desktop/ListOut10.txt", "-province", "全国", "加利福尼亚", "福建",
            "-date" ,"2020-01-24"};
            InfectStatistic.main(commands);
        }
    }
